...
if (z[position[i]]!=0){
a=a+z[position[i]]*(1/dist_f[i]^puissance)
b=b+(1/dist_f[i]^puissance)
}
}
}
}
...
if (!is.na(z[position[i]])){
if (z[position[i]]!=0){
a=a+z[position[i]]*(1/(1+dist_f[i]^puissance))
b=b+(1/(1+dist_f[i]^puissance))
}
}
}
}
...
if (!is.na(z[position[i]])){
if (z[position[i]]!=0){
a0=a0+z[position[i]]*(1/dist_f[i]^puissance)
b0=b0+(1/dist_f[i]^puissance)
a1=a1+z[position[i]]*(1/(1+dist_f[i]^puissance))
b1=b1+(1/(1+dist_f[i]^puissance))
